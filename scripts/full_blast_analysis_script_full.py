...
def auto_blast(queryfile, database, outname):
    blast_command = ['blastn', '-query', queryfile, '-db',  database, '-out', outname,  '-num_threads', '8', '-outfmt', '5']
...
auto_blast(fasta_outname, db, xml_outname)
